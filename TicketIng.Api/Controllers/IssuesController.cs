...
namespace TicketIng.Api.Controllers
{
    ...
    public class IssuesController : ControllerBase
    {
        ...
        public IssuesController(IssueRepository repo) => _repo = repo;
        ...
        [HttpPost]
        public async Task<ActionResult<Issue>> Create(Issue entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, Issue entity)
        {
